<form action="#" id="example-form">
    ...
    <div class="form-group my-2">
        @if ($data->criteriaType->type == 'Teks')
            ...
            <input type="text" id="{{ $data->id }}" name="{{ $data->id }}" minlength="{{ $data->min_length }}"
                maxlength="{{ $data->max_length }}" {{ $data->required ? 'required' : '' }} class="form-control">
        @endif
        @if ($data->criteriaType->type == 'Angka')
            ...
            <input type="number" id="{{ $data->id }}" name="{{ $data->id }}"
                minlength="{{ $data->min_length }}" maxlength="{{ $data->max_length }}" min="{{ $data->min_number }}"
                max="{{ $data->max_number }}" {{ $data->required ? 'required' : '' }} class="form-control">
        @endif
