    ...
    <div class="card-body">
        ...
        <div class="form-group my-2">
            ...
            <div class="input-icon mb-2">
                ...
                <input class="form-control" placeholder="Pilih tanggal" name="deadline" id="deadline" value="{{ old('deadline') ? old('deadline') : (isset($data) && $data->deadline ? $data->deadline : '') }}" required>
            </div>
        </div>
        <div class="form-group my-2">
